export const Title: React.FC = () => {
    return <div className="TitleContainer">
        ...
        <div>
            ...
            <p>PCでの使用を想定しており、スマホだと使いにくいと思います。</p>
        ...
        <div>
            ...
            <ul>
                <li>集中講義登録機能を追加。</li>
                <li>フォームとカウンタのレイアウトを更新。</li>
                <li>カウンタにホバーしたときにツールチップを表示する機能を追加</li>
                <li>時間割で土日を表示するかどうかを選択できるように変更</li>
                <li>科目の区分の種類を追加</li>
                <li>科目の区分選択時に色が自動的に設定されるように変更</li>
            </ul>
        </div>
    </div>
}